<?php
// ============================================================
// MrsB Tracker — First-Time Password Setup (email-based)
// ============================================================
...
// Must have a pending client from login
if (empty($_SESSION['pending_client_id'])) {
    redirect(SITE_URL . '/tracker/login.php');
}

$client = getClientById((int)$_SESSION['pending_client_id']);
if (!$client) {
    redirect(SITE_URL . '/tracker/login.php');
}
    ...
    <div class="login-card" style="background:#fff;border-radius:12px;padding:2rem;box-shadow:0 4px 24px rgba(74,25,66,0.10);">
        ...
        <div style="text-align:center;margin-bottom:1.5rem;">
            ...
            <p style="color:#9a7a96;font-size:0.9rem;margin-top:0.5rem;">
                Create a password to secure your personal tracker.
                You'll use this with your email to log in each time.
            </p>
        </div>
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <div style="position:relative;">
                    <input type="password" name="password" id="password"
                           ...
                           style="padding-right:3rem;" autofocus autocomplete="new-password">
            ...
            <div class="form-group">
                ...
                <div style="position:relative;">
                    ...
                    <button type="button" onclick="toggleField('confirm')"
                            style="position:absolute;right:0.75rem;top:50%;transform:translateY(-50%);background:none;border:none;cursor:pointer;color:#9a7a96;">
                        👁
                    </button>
                </div>
