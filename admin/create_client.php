...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $clientId   = createClient(['name' => $name, 'email' => $email, 'start_date' => $startDate]);
...
Your Mrs B Fitness Programme Tracker is ready! Use the link below to record your weekly progress, class passwords, and measurements throughout your 6-week programme.
